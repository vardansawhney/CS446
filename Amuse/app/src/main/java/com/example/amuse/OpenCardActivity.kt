...
class OpenCardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val event = localStore.currentAvailableEventsStack[0]
        ...
        if(event.price_level != null){
         ...
         if(event.description !=null){
             findViewById<TextView>(R.id.description_open).text = event.description
         }else{
             findViewById<TextView>(R.id.description_open).text = ""
         }
//        when (cardID) {
//            "card1" -> {
//                Log.e("TAG", "- 1 -")
